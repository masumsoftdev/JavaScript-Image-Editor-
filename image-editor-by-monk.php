...
class CustomImageEditor {
    ...
    public function render_editor() {
        ob_start();
        ?>
        <button id="openEditor" class="btn btn-primary">Open Image Editor</button>
    
        <!-- Popup Modal -->
        <div id="imageEditorModal" class="modal" tabindex="-1" role="dialog">
                            ...
                            <div class="row mb-3" id="editor-controls">
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    ...
                                    <button id="transparentBackground" class="btn btn-secondary">Transparent</button>
                                </div>
                            </div>
                            <div class="row">
